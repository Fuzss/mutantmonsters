...
public class ModTags {
    ...
    public static final TagKey<EntityType<?>> SPIDER_PIG_TARGETS_ENTITY_TYPE_TAG = TAGS.registerEntityTypeTag(
            "spider_pig_targets");
    public static final TagKey<EntityType<?>> SPIDER_PIG_FRIENDS_ENTITY_TYPE_TAG = TAGS.registerEntityTypeTag(
            "spider_pig_friends");
    public static final TagKey<Item> SPIDER_PIG_FOOD_ITEM_TAG = TAGS.registerItemTag("spider_pig_food");
    public static final TagKey<EntityType<?>> ENDER_FRIENDS_ENTITY_TYPE_TAG = TAGS.registerEntityTypeTag("ender_friends");
