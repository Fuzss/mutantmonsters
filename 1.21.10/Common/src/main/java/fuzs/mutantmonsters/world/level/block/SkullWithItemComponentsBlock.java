...
public class SkullWithItemComponentsBlock extends SkullBlock {

    public SkullWithItemComponentsBlock(SkullBlock.Type skullType, BlockBehaviour.Properties properties) {
