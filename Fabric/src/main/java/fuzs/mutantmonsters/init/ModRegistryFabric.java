...
public class ModRegistryFabric {
    public static final RegistryReference<EntityType<MutantArrow>> MUTANT_ARROW_ENTITY_TYPE = REGISTRY.register(Registry.ENTITY_TYPE_REGISTRY, "mutant_arrow", () -> FabricEntityTypeBuilder.<MutantArrow>create(MobCategory.MISC, MutantArrow::new).forceTrackedVelocityUpdates(false).disableSaving().build());
    public static final RegistryReference<EntityType<SkullSpirit>> SKULL_SPIRIT_ENTITY_TYPE = REGISTRY.register(Registry.ENTITY_TYPE_REGISTRY, "skull_spirit", () -> FabricEntityTypeBuilder.<SkullSpirit>create(MobCategory.MISC, SkullSpirit::new).trackRangeChunks(10).trackedUpdateRate(20).forceTrackedVelocityUpdates(false).dimensions(EntityDimensions.scalable(0.1F, 0.1F)).build());
