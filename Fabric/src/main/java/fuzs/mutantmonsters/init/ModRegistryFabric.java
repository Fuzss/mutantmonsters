...
public class ModRegistryFabric {
    ...
    public static final RegistryReference<EntityType<MutantArrow>> MUTANT_ARROW_ENTITY_TYPE = REGISTRY.registerEntityType("mutant_arrow", () -> FabricEntityTypeBuilder.<MutantArrow>create(MobCategory.MISC, MutantArrow::new).forceTrackedVelocityUpdates(false).disableSaving().build());
