...
public class ModRegistryFabric {
    ...
    public static final RegistryReference<EntityType<SkullSpiritEntity>> SKULL_SPIRIT_ENTITY_TYPE = REGISTRY.registerEntityType("skull_spirit", () -> FabricEntityTypeBuilder.<SkullSpiritEntity>create(MobCategory.MISC, SkullSpiritEntity::new).trackRangeChunks(10).trackedUpdateRate(20).forceTrackedVelocityUpdates(false).dimensions(EntityDimensions.scalable(0.1F, 0.1F)).build());
