...
import fuzs.mutantmonsters.util.ZombieResurrection;
...
public class MutantZombieEntity extends Monster implements IAnimatedEntity {
    ...
    private static final EntityDataAccessor<Byte> THROW_ATTACK_STATE;
    public static final int MAX_VANISH_TIME = 100;
    public static final int MAX_DEATH_TIME = 140;
    public static final Animation SLAM_GROUND_ANIMATION;
    public static final Animation THROW_ANIMATION;
    public static final Animation ROAR_ANIMATION;
    ...
    public MutantZombieEntity(EntityType<? extends MutantZombieEntity> type, Level worldIn) {
        super(type, worldIn);
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, (new MBMeleeAttackGoal(this, 1.2)).setMaxAttackTick(0));
    ...
    public static AttributeSupplier.Builder registerAttributes() {
        return createMonsterAttributes().add(Attributes.MAX_HEALTH, 150.0).add(Attributes.ATTACK_DAMAGE, 12.0).add(Attributes.FOLLOW_RANGE, 35.0).add(Attributes.MOVEMENT_SPEED, 0.26).add(Attributes.KNOCKBACK_RESISTANCE, 1.0).add(ForgeMod.SWIM_SPEED.get(), 4.0);
    }
    ...
    private boolean canHarm(Entity entity) {
        return entity.getType() != EntityType.ZOMBIE && entity.getType() != EntityType.ZOMBIE_VILLAGER && entity.getType() != EntityType.HUSK && entity.getType() != EntityType.DROWNED && !(entity instanceof MutantZombieEntity);
    }
    ...
    static {
        LIVES = SynchedEntityData.defineId(MutantZombieEntity.class, EntityDataSerializers.INT);
        THROW_ATTACK_STATE = SynchedEntityData.defineId(MutantZombieEntity.class, EntityDataSerializers.BYTE);
        SLAM_GROUND_ANIMATION = new Animation(25);
        THROW_ANIMATION = new Animation(15);
        ROAR_ANIMATION = new Animation(120);
        ANIMATIONS = new Animation[]{SLAM_GROUND_ANIMATION, THROW_ANIMATION, ROAR_ANIMATION};
    }

    static class ThrowAttackGoal extends AnimationGoal<MutantZombieEntity> {
        ...
        protected Animation getAnimation() {
            return MutantZombieEntity.THROW_ANIMATION;
        }
        ...
        public void tick() {
            ...
            double x;
            double z;
            if (this.mob.animationTick == MutantZombieEntity.THROW_ANIMATION.getDuration()) {
            ...
            } else if (this.mob.animationTick > MutantZombieEntity.THROW_ANIMATION.getDuration()) {
    ...
    static class RoarGoal extends AnimationGoal<MutantZombieEntity> {
        ...
        @Override
        protected Animation getAnimation() {
            return MutantZombieEntity.ROAR_ANIMATION;
        }
    ...
    static class SlamGroundGoal extends AnimationGoal<MutantZombieEntity> {
        ...
        @Override
        protected Animation getAnimation() {
            return MutantZombieEntity.SLAM_GROUND_ANIMATION;
        }
