...
import fuzs.mutantmonsters.client.renderer.entity.model.MutantSkeletonPartModel;
...
public class BodyPartRenderer extends EntityRenderer<BodyPartEntity> {
    ...
    @Override
    public void render(BodyPartEntity entityIn, float entityYaw, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn) {
    ...
    @Override
    public ResourceLocation getTextureLocation(BodyPartEntity entity) {
