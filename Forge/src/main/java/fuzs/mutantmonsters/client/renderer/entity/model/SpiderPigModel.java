...
public class SpiderPigModel extends AgeableListModel<SpiderPigEntity> {
    ...
    public SpiderPigModel(ModelPart modelPart) {
        ...
        this.lowerFrontLeg1 = this.frontLeg1.getChild("lower_front_leg1");
        ...
        this.lowerFrontLeg2 = this.frontLeg2.getChild("lower_front_leg2");
        ...
        this.lowerMiddleLeg1 = this.middleLeg1.getChild("lower_middle_leg1");
        ...
        this.lowerMiddleLeg2 = this.middleLeg2.getChild("lower_middle_leg2");
        ...
        this.lowerBackLeg1 = this.backLeg1.getChild("lower_back_leg1");
        ...
        this.lowerBackLeg2 = this.backLeg2.getChild("lower_back_leg2");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        head.addOrReplaceChild("inner_head", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -4.0F, -8.0F, 8.0F, 8.0F, 8.0F), PartPose.ZERO);
        head.addOrReplaceChild("snout", CubeListBuilder.create().texOffs(24, 0).addBox(-2.0F, 0.0F, -9.0F, 4.0F, 3.0F, 1.0F), PartPose.ZERO);
        ...
        frontLeg1.addOrReplaceChild("inner_front_leg1", CubeListBuilder.create().texOffs(0, 37).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 12.0F, 2.0F), PartPose.ZERO);
        PartDefinition lowerFrontLeg1 = frontLeg1.addOrReplaceChild("lower_front_leg1", CubeListBuilder.create().texOffs(8, 37), PartPose.offset(-0.0F, 12.0F, -0.1F));
        ...
        frontLeg2.addOrReplaceChild("inner_front_leg2", CubeListBuilder.create().texOffs(0, 37).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 12.0F, 2.0F), PartPose.ZERO);
        PartDefinition lowerFrontLeg2 = frontLeg2.addOrReplaceChild("lower_front_leg2", CubeListBuilder.create().texOffs(8, 37).mirror(), PartPose.offset(0.0F, 12.0F, 0.1F));
        ...
        middleLeg1.addOrReplaceChild("inner_middle_leg1", CubeListBuilder.create().texOffs(0, 37).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 12.0F, 2.0F), PartPose.ZERO);
        PartDefinition lowerMiddleLeg1 = middleLeg1.addOrReplaceChild("lower_middle_leg1", CubeListBuilder.create().texOffs(8, 37), PartPose.offset(0.0F, 12.0F, -0.1F));
        ...
        middleLeg2.addOrReplaceChild("inner_middle_leg2", CubeListBuilder.create().texOffs(0, 37).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 12.0F, 2.0F), PartPose.ZERO);
        PartDefinition lowerMiddleLeg2 = middleLeg2.addOrReplaceChild("lower_middle_leg2", CubeListBuilder.create().texOffs(8, 37).mirror(), PartPose.offset(0.0F, 12.0F, 0.1F));
        ...
        backLeg1.addOrReplaceChild("inner_back_leg1", CubeListBuilder.create().texOffs(16, 37).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 4.0F, 4.0F), PartPose.ZERO);
        PartDefinition lowerBackLeg1 = backLeg1.addOrReplaceChild("lower_back_leg1", CubeListBuilder.create().texOffs(16, 45), PartPose.offset(0.0F, 3.0F, 0.0F));
        ...
        backLeg2.addOrReplaceChild("inner_back_leg2", CubeListBuilder.create().texOffs(32, 37).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 4.0F, 4.0F), PartPose.ZERO);
        PartDefinition lowerBackLeg2 = backLeg2.addOrReplaceChild("lower_back_leg2", CubeListBuilder.create().texOffs(16, 45).mirror(), PartPose.offset(0.0F, 3.0F, 0.0F));
    ...
    public void setupAnim(SpiderPigEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        Animator.resetAngles(this.backLeg1, this.innerBackLeg1, this.lowerBackLeg1, this.innerLowerFrontLeg2, this.backLeg2, this.innerBackLeg2, this.lowerBackLeg2, this.innerLowerBackLeg2);
        ...
        this.innerLowerFrontLeg2.xRot += 0.5711987F;
