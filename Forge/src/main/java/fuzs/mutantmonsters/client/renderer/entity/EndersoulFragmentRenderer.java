...
public class EndersoulFragmentRenderer extends EntityRenderer<EndersoulFragmentEntity> {
    ...
    public EndersoulFragmentRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new EndersoulFragmentModel(context.bakeLayer(ClientModRegistry.ENDER_SOUL_FRAGMENT));
        this.shadowRadius = 0.3F;
        this.shadowStrength = 0.5F;
    }

    @Override
    public void render(EndersoulFragmentEntity entityIn, float entityYaw, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn) {
    ...
    @Override
    public ResourceLocation getTextureLocation(EndersoulFragmentEntity entity) {
        return TEXTURE;
    }
}
