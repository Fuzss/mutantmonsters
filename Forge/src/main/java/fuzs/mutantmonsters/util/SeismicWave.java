...
import fuzs.mutantmonsters.packet.FluidParticlePacket;
        ...
        if (this.affectsTerrain) {
            ...
            if (playerEntity != null && playerEntity.mayBuild() || world.getGameRules().getBoolean(GameRules.RULE_MOBGRIEFING)) {
                ...
                if (block instanceof TntBlock) {
                    block.onCaughtFire(blockstate, world, this, null, playerEntity);
            ...
            if (blockstate.getFluidState().isEmpty()) {
                ...
                MBPacketHandler.INSTANCE.send(PacketDistributor.NEAR.with(() -> {
                    return new PacketDistributor.TargetPoint((double)this.getX() + 0.5, (double)this.getY(), (double)this.getZ() + 0.5, 1024.0, entity.level.dimension());
