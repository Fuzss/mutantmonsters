...
public class ModSoundDefinitionProvider extends AbstractSoundDefinitionProvider {
    ...
    public void addSoundDefinitions() {
        ...
        this.add(ModSoundEvents.ENTITY_MUTANT_CREEPER_AMBIENT_SOUND_EVENT.value(),
                ...
                MutantMonsters.id("entity/mutant_creeper/ambient3"), MutantMonsters.id("entity/mutant_creeper/ambient4")
        );
        ...
        this.add(ModSoundEvents.ENTITY_MUTANT_CREEPER_HURT_SOUND_EVENT.value(),
                MutantMonsters.id("entity/mutant_creeper/hurt1"), MutantMonsters.id("entity/mutant_creeper/hurt2")
        );
        ...
        this.add(ModSoundEvents.ENTITY_MUTANT_ENDERMAN_HURT_SOUND_EVENT.value(),
                MutantMonsters.id("entity/mutant_enderman/hurt1"), MutantMonsters.id("entity/mutant_enderman/hurt2"),
        ...
        this.add(ModSoundEvents.ENTITY_MUTANT_SKELETON_HURT_SOUND_EVENT.value(),
                MutantMonsters.id("entity/mutant_skeleton/hurt1"), MutantMonsters.id("entity/mutant_skeleton/hurt2"),
                MutantMonsters.id("entity/mutant_skeleton/hurt3"), MutantMonsters.id("entity/mutant_skeleton/hurt4")
        );
        this.add(ModSoundEvents.ENTITY_MUTANT_SKELETON_STEP_SOUND_EVENT.value(),
                MutantMonsters.id("entity/mutant_skeleton/step1"), MutantMonsters.id("entity/mutant_skeleton/step2"),
                MutantMonsters.id("entity/mutant_skeleton/step3"), MutantMonsters.id("entity/mutant_skeleton/step4")
        );
        ...
        this.add(ModSoundEvents.ENTITY_MUTANT_ZOMBIE_AMBIENT_SOUND_EVENT.value(),
                MutantMonsters.id("entity/mutant_zombie/ambient1"), MutantMonsters.id("entity/mutant_zombie/ambient2"),
        ...
        this.add(ModSoundEvents.ENTITY_MUTANT_ZOMBIE_DEATH_SOUND_EVENT.value(),
                MutantMonsters.id("entity/mutant_zombie/hurt1"), MutantMonsters.id("entity/mutant_zombie/hurt2")
        );
        ...
        this.add(ModSoundEvents.ENTITY_MUTANT_ZOMBIE_ROAR_SOUND_EVENT.value(), sound(
                        MutantMonsters.id("entity/mutant_zombie/roar1")).attenuationDistance(32).weight(2), sound(
                        MutantMonsters.id("entity/mutant_zombie/roar2")).attenuationDistance(32).weight(2),
