...
public class ModItemTagProvider extends AbstractTagProvider<Item> {
    ...
    public void addTags(HolderLookup.Provider provider) {
        ...
        this.add(ItemTags.DURABILITY_ENCHANTABLE).add(ModItems.CREEPER_SHARD_ITEM.value(),
                ModItems.HULK_HAMMER_ITEM.value(), ModItems.ENDERSOUL_HAND_ITEM.value(),
                ModItems.MUTANT_SKELETON_SKULL_ITEM.value(), ModItems.ENDERSOUL_HAND_ITEM.value()
        );
        ...
        this.add(ItemTags.TRIMMABLE_ARMOR).remove(ModItems.MUTANT_SKELETON_SKULL_ITEM.value(),
                ModItems.MUTANT_SKELETON_CHESTPLATE_ITEM.value(), ModItems.MUTANT_SKELETON_LEGGINGS_ITEM.value(),
