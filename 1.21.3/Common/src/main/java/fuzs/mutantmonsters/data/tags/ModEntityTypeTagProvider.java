...
public class ModEntityTypeTagProvider extends AbstractTagProvider<EntityType<?>> {
    ...
    public void addTags(HolderLookup.Provider provider) {
        ...
        this.add(ModRegistry.MUTANTS_ENTITY_TYPE_TAG).add(ModEntityTypes.MUTANT_CREEPER_ENTITY_TYPE.value(),
                ModEntityTypes.MUTANT_ENDERMAN_ENTITY_TYPE.value(), ModEntityTypes.MUTANT_SKELETON_ENTITY_TYPE.value(),
                ModEntityTypes.MUTANT_SNOW_GOLEM_ENTITY_TYPE.value(), ModEntityTypes.MUTANT_ZOMBIE_ENTITY_TYPE.value()
        );
        this.add(ModRegistry.SPIDER_PIG_TARGETS_ENTITY_TYPE_TAG).add(EntityType.SPIDER, EntityType.PIG);
        this.add("enderzoology:concussion_immune").add(ModEntityTypes.MUTANT_ENDERMAN_ENTITY_TYPE.value(),
                ModEntityTypes.ENDERSOUL_CLONE_ENTITY_TYPE.value()
        );
        this.add(EntityTypeTags.UNDEAD).add(ModEntityTypes.MUTANT_SKELETON_ENTITY_TYPE.value(),
        ...
        this.add(EntityTypeTags.FALL_DAMAGE_IMMUNE).add(ModEntityTypes.SPIDER_PIG_ENTITY_TYPE.value()).addTag(
                ModRegistry.MUTANTS_ENTITY_TYPE_TAG);
    }
}
