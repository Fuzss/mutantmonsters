...
public class ModRecipeProvider extends AbstractRecipeProvider {
    ...
    public void addRecipes(RecipeOutput recipeOutput) {
        ShapedRecipeBuilder.shaped(this.items(), RecipeCategory.TOOLS, ModItems.CREEPER_MINION_TRACKER_ITEM.value())
                ...
                .save(recipeOutput);
        ShapedRecipeBuilder.shaped(this.items(), RecipeCategory.COMBAT, ModItems.MUTANT_SKELETON_ARMS_ITEM.value())
                ...
                .save(recipeOutput);
        ShapedRecipeBuilder.shaped(this.items(), RecipeCategory.COMBAT, ModItems.MUTANT_SKELETON_BOOTS_ITEM.value())
                .define('L', ModItems.MUTANT_SKELETON_LIMB_ITEM.value())
                .pattern("L L")
                .unlockedBy(getHasName(ModItems.MUTANT_SKELETON_LIMB_ITEM.value()),
                        this.has(ModItems.MUTANT_SKELETON_LIMB_ITEM.value()))
        ...
        ShapedRecipeBuilder.shaped(this.items(),
                ...
                .save(recipeOutput);
        ShapedRecipeBuilder.shaped(this.items(), RecipeCategory.COMBAT, ModItems.MUTANT_SKELETON_LEGGINGS_ITEM.value())
                ...
                .unlockedBy(getHasName(ModItems.MUTANT_SKELETON_LIMB_ITEM.value()),
                        this.has(ModItems.MUTANT_SKELETON_LIMB_ITEM.value()))
                .save(recipeOutput);
        ShapedRecipeBuilder.shaped(this.items(), RecipeCategory.COMBAT, ModItems.MUTANT_SKELETON_RIB_CAGE_ITEM.value())
