...
public class MutantSnowGolemEntity extends AbstractGolem implements RangedAttackMob, Shearable {
    private static final EntityDataAccessor<Optional<UUID>> OWNER_UNIQUE_ID = SynchedEntityData.defineId(MutantSnowGolemEntity.class, EntityDataSerializers.OPTIONAL_UUID);
    private static final EntityDataAccessor<Byte> STATUS = SynchedEntityData.defineId(MutantSnowGolemEntity.class, EntityDataSerializers.BYTE);
