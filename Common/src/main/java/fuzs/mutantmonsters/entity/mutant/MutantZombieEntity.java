...
public class MutantZombieEntity extends Monster implements AnimatedEntity {
    private static final EntityDataAccessor<Integer> LIVES = SynchedEntityData.defineId(MutantZombieEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Byte> THROW_ATTACK_STATE = SynchedEntityData.defineId(MutantZombieEntity.class, EntityDataSerializers.BYTE);
    ...
    static class ThrowAttackGoal extends AnimationGoal<MutantZombieEntity> {
        ...
        public void tick() {
            ...
            double x;
            double z;
            if (this.mob.animationTick == MutantZombieEntity.THROW_ANIMATION.duration()) {
            ...
            } else if (this.mob.animationTick > MutantZombieEntity.THROW_ANIMATION.duration()) {
