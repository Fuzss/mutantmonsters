...
public class MutantArrowEntity extends Entity {
    private static final EntityDataAccessor<Integer> TARGET_X = SynchedEntityData.defineId(MutantArrowEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> TARGET_Y = SynchedEntityData.defineId(MutantArrowEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> TARGET_Z = SynchedEntityData.defineId(MutantArrowEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Float> SPEED = SynchedEntityData.defineId(MutantArrowEntity.class, EntityDataSerializers.FLOAT);
    private static final EntityDataAccessor<Integer> CLONES = SynchedEntityData.defineId(MutantArrowEntity.class, EntityDataSerializers.INT);
    private int damage;
