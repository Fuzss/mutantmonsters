...
public class MutantSnowGolemModel extends EntityModel<MutantSnowGolemEntity> {
    ...
    @Override
    public void setupAnim(MutantSnowGolemEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        this.setAngles();
    ...
    @Override
    public void prepareMobModel(MutantSnowGolemEntity entityIn, float limbSwing, float limbSwingAmount, float partialTick) {
