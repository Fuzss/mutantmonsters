...
public class MutantEndermanModel extends EntityModel<MutantEndermanRenderState> {
    ...
    public MutantEndermanModel(ModelPart modelPart) {
        ...
        this.rightArm = new Arm(this.chest, "right_", true);
        this.leftArm = new Arm(this.chest, "left_", false);
        this.lowerRightArm = new Arm(this.chest, "lower_right_", true);
        this.lowerLeftArm = new Arm(this.chest, "lower_left_", false);
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        Arm.createArmLayer(chest, "lower_right_", true, true);
        Arm.createArmLayer(chest, "lower_left_", false, true);
        ...
        PartDefinition legJoint2 = abdomen.addOrReplaceChild("leg_joint2",
                CubeListBuilder.create().texOffs(0, 0),
                PartPose.offset(1.5F, 0.0F, 0.75F));
        PartDefinition leg1 = legJoint1.addOrReplaceChild("leg1",
                CubeListBuilder.create()
                        .texOffs(0, 34)
                        .addBox(-1.5F, 0.0F, -1.5F, 3.0F, 24.0F, 3.0F, new CubeDeformation(0.5F)),
                PartPose.offset(0.0F, -2.0F, 0.0F));
        PartDefinition leg2 = legJoint2.addOrReplaceChild("leg2",
                CubeListBuilder.create()
                        .texOffs(0, 34)
                        .mirror()
                        .addBox(-1.5F, 0.0F, -1.5F, 3.0F, 24.0F, 3.0F, new CubeDeformation(0.5F)),
    ...
    private void setupInitialAngles() {
        ...
        this.rightArm.setupAnim(Unit.INSTANCE);
        this.leftArm.setupAnim(Unit.INSTANCE);
        this.lowerRightArm.setupAnim(Unit.INSTANCE);
        this.lowerRightArm.arm.xRot += 0.1F;
        this.lowerRightArm.arm.zRot -= 0.2F;
        this.lowerLeftArm.setupAnim(Unit.INSTANCE);
        ...
        public static void createArmLayer(PartDefinition root, String prefix, boolean right, boolean lower) {
            PartDefinition arm = root.addOrReplaceChild(prefix + "arm",
                    CubeListBuilder.create()
                            ...
                            .mirror(!right),
                    PartPose.offset(right ? -4.0F : 4.0F, -14.0F, 0.0F));
