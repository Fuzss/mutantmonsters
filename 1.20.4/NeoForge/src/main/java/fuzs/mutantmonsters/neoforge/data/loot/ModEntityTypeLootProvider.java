package fuzs.mutantmonsters.neoforge.data.loot;
...
public class ModEntityTypeLootProvider extends AbstractLootProvider.EntityTypes {
    ...
    public void addLootTables() {
        ...
        // TODO fix existing loot table references
        this.add(ModRegistry.SPIDER_PIG_ENTITY_TYPE.value(), LootTable.lootTable());
