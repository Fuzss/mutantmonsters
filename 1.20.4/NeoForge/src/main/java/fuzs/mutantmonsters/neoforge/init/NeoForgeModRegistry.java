...
public class NeoForgeModRegistry {
    ...
    public static final Holder.Reference<Item> MUTANT_SKELETON_SKULL_ITEM = REGISTRY.registerItem("mutant_skeleton_skull", () -> new ArmorBlockNeoForgeItem(MutantSkeletonArmorMaterial.INSTANCE, ModRegistry.MUTANT_SKELETON_SKULL_BLOCK.value(), ModRegistry.MUTANT_SKELETON_WALL_SKULL_BLOCK.value(), new Item.Properties().rarity(Rarity.UNCOMMON)));
