...
public class MutantMonstersClient implements ClientModConstructor {
    ...
    public void onRegisterEntityRenderers(EntityRenderersContext context) {
        context.registerEntityRenderer(ModRegistry.BODY_PART_ENTITY_TYPE.value(), BodyPartRenderer::new);
        context.registerEntityRenderer(ModRegistry.CREEPER_MINION_ENTITY_TYPE.value(), CreeperMinionRenderer::new);
        context.registerEntityRenderer(ModRegistry.CREEPER_MINION_EGG_ENTITY_TYPE.value(), CreeperMinionEggRenderer::new);
        context.registerEntityRenderer(ModRegistry.ENDERSOUL_CLONE_ENTITY_TYPE.value(), EndersoulCloneRenderer::new);
        context.registerEntityRenderer(ModRegistry.ENDERSOUL_FRAGMENT_ENTITY_TYPE.value(), EndersoulFragmentRenderer::new);
        context.registerEntityRenderer(ModRegistry.MUTANT_ARROW_ENTITY_TYPE.value(), MutantArrowRenderer::new);
        context.registerEntityRenderer(ModRegistry.MUTANT_CREEPER_ENTITY_TYPE.value(), MutantCreeperRenderer::new);
        context.registerEntityRenderer(ModRegistry.MUTANT_ENDERMAN_ENTITY_TYPE.value(), MutantEndermanRenderer::new);
        context.registerEntityRenderer(ModRegistry.MUTANT_SKELETON_ENTITY_TYPE.value(), MutantSkeletonRenderer::new);
        context.registerEntityRenderer(ModRegistry.MUTANT_SNOW_GOLEM_ENTITY_TYPE.value(), MutantSnowGolemRenderer::new);
        context.registerEntityRenderer(ModRegistry.MUTANT_ZOMBIE_ENTITY_TYPE.value(), MutantZombieRenderer::new);
        context.registerEntityRenderer(ModRegistry.SKULL_SPIRIT_ENTITY_TYPE.value(), context1 -> {
        ...
        context.registerEntityRenderer(ModRegistry.SPIDER_PIG_ENTITY_TYPE.value(), SpiderPigRenderer::new);
        context.registerEntityRenderer(ModRegistry.THROWABLE_BLOCK_ENTITY_TYPE.value(), ThrowableBlockRenderer::new);
    }
    ...
    public void onRegisterBuiltinModelItemRenderers(BuiltinModelItemRendererContext context) {
        context.registerItemRenderer(new EndersoulHandRenderer(), ModRegistry.ENDERSOUL_HAND_ITEM.value());
    }

    @Override
    public void onRegisterParticleProviders(ParticleProvidersContext context) {
        context.registerParticleProvider(ModRegistry.ENDERSOUL_PARTICLE_TYPE.value(), EndersoulParticle.Factory::new);
        context.registerParticleProvider(ModRegistry.SKULL_SPIRIT_PARTICLE_TYPE.value(), SkullSpiritParticle.Factory::new);
    }
    ...
    public void onRegisterEntitySpectatorShaders(EntitySpectatorShaderContext context) {
        context.registerSpectatorShader(new ResourceLocation("shaders/post/creeper.json"), ModRegistry.CREEPER_MINION_ENTITY_TYPE.value(), ModRegistry.MUTANT_CREEPER_ENTITY_TYPE.value());
        context.registerSpectatorShader(new ResourceLocation("shaders/post/invert.json"), ModRegistry.ENDERSOUL_CLONE_ENTITY_TYPE.value(), ModRegistry.MUTANT_ENDERMAN_ENTITY_TYPE.value());
    }
