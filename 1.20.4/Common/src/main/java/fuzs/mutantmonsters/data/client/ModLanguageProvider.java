...
public class ModLanguageProvider extends AbstractLanguageProvider {
    ...
    public void addTranslations(TranslationBuilder builder) {
        ...
        builder.add(CreeperMinionTrackerScreen.EXPLOSION_COMPONENT, "Health");
        ...
        // TODO convert these to dedicated spawn egg method
        builder.add(ModRegistry.CREEPER_MINION_SPAWN_EGG_ITEM.value(), "Creeper Minion");
        builder.add(ModRegistry.MUTANT_CREEPER_SPAWN_EGG_ITEM.value(), "Mutant Creeper");
        builder.add(ModRegistry.MUTANT_ENDERMAN_SPAWN_EGG_ITEM.value(), "Mutant Enderman");
        builder.add(ModRegistry.MUTANT_SKELETON_SPAWN_EGG_ITEM.value(), "Mutant Skeleton");
        builder.add(ModRegistry.MUTANT_SNOW_GOLEM_SPAWN_EGG_ITEM.value(), "Mutant Snow Golem");
        builder.add(ModRegistry.MUTANT_ZOMBIE_SPAWN_EGG_ITEM.value(), "Mutant Zombie");
