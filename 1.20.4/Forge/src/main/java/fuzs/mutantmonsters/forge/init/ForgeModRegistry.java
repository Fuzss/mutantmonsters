...
public class ForgeModRegistry {
    ...
    public static final Holder.Reference<Item> MUTANT_SKELETON_SKULL_ITEM = REGISTRY.registerItem("mutant_skeleton_skull", () -> new ArmorBlockForgeItem(
            ModRegistry.MUTANT_SKELETON_ARMOR_MATERIAL, ModRegistry.MUTANT_SKELETON_SKULL_BLOCK.get(), ModRegistry.MUTANT_SKELETON_WALL_SKULL_BLOCK.get(), new Item.Properties().rarity(Rarity.UNCOMMON)));
