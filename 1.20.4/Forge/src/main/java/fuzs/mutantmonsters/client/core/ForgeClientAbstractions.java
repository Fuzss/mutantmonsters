...
public class ForgeClientAbstractions implements ClientAbstractions {
    ...
    @Override
    public <T extends LivingEntity, M extends EntityModel<T>> boolean onRenderLiving$Pre(LivingEntity entity, LivingEntityRenderer<T, M> renderer, float partialTick, PoseStack poseStack, MultiBufferSource multiBufferSource, int packedLight) {
    ...
    @SuppressWarnings("UnstableApiUsage")
    @Override
    public <T extends LivingEntity, M extends EntityModel<T>> void onRenderLiving$Post(LivingEntity entity, LivingEntityRenderer<T, M> renderer, float partialTick, PoseStack poseStack, MultiBufferSource multiBufferSource, int packedLight) {
